package com.aaditi.collection.map.linkedhashmap;
...
public class LinkedHashMapWithCustomObjectWithHashCodeAndEqualMethodOverrideDemo {

	private static void linkedHashMapWithCustomObjectWithHashCodeAndEqualMethodOverride() {
		...
		Person emp5 = new Person(1, "Akshay", "Male", "USA");
	...
	public static void main(String[] args) {
		...
		linkedHashMapWithCustomObjectWithHashCodeAndEqualMethodOverride();
	}
